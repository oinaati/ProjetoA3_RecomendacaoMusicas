 ...
 * @author natim
 */
public class RecomendaTela extends javax.swing.JFrame {

    /**
     * Creates new form RecomendaTela
     */
    public RecomendaTela() {
        super ("Recomendações");
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Minhas recomendações ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecomendaTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecomendaTela().setVisible(true);
            }
        });
    }
